			...
			this.defaults = {
				feeds: {
					facebook: {
                        ...
                        url: '../../../../wwwroot/SocialWall/facebook.php',
					...
					twitter: {
                        ...
                        url: '../../../../wwwroot/SocialWall/twitter.php',
						icon: 'twitter.png'
					},
					google: {
						id: '',
						...
						image_width: 75,
						shares: true,
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/google.png'
					},
					youtube: {
						id: '',
						intro: 'Uploaded',
                        ...
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/youtube.png'
					},
					flickr: {
						id: '',
						intro: 'Uploaded',
						out: 'intro,thumb,title,text,share',
						lang: 'en-us',
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/flickr.png'
					},
					delicious: {
						id: '',
						intro: 'Bookmarked',
						out: 'intro,thumb,title,text,user,share',
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/delicious.png'
					},
					pinterest: {
						id: '',
						intro: 'Pinned',
						out: 'intro,thumb,text,user,share',
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/pinterest.png'
					},
					rss: {
						id: '',
						intro: 'Posted',
						...
						text: 'contentSnippet',
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/rss.png'
					},
					lastfm: {
						id: '',
                        ...
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/lastfm.png'
					},
					dribbble: {
						id: '',
						intro: 'Posted,Liked',
						out: 'intro,thumb,title,text,user,share',
						feed: 'shots,likes',
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/dribbble.png'
					},
					vimeo: {
						id: '',
						...
						thumb: 'medium',
						stats: true,
                        icon: '../../../../wwwroot/SocialWall/images/dcsns-dark/vimeo.png'
					},
					stumbleupon: {
						id: '',
