...
export class EmployeeComponent implements OnInit {
    ...
    LoadUsers(): void {
        ...
        this._userService.get(Global.BASE_USER_ENDPOINT + '/GetAllUsers')
            .subscribe(users => {
                this.users = users;
    ...
    onSubmit(formData: any) {
        ...
        switch (this.dbops) {
            case DBOperation.create:
                this._userService.post(Global.BASE_USER_ENDPOINT +'/SaveUserDetails', formData.value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.update:
                this._userService.put(Global.BASE_USER_ENDPOINT +'/UpdateUserDetails?id=', formData.value.UserID, formData.value).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
            ...
            case DBOperation.delete:
                this._userService.delete(Global.BASE_USER_ENDPOINT +'/DeleteUserDetails?id=', formData.value.UserID).subscribe(
                    data => {
                        if (data == 1) //Success
                        {
